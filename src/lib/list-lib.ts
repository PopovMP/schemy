class ListLib implements ILib {
	...
	private car(expr: any[], env: any[]): any | any[] {
		const [obj]: any[] = <[any[]]>this.inter.evalArgs(['list'], expr, env)
	...
	private append(expr: any[], env: any[]): any[] {
		const [list, item]: [any[], any] = <[any[], any]>this.inter.evalArgs(['list', 'any'], expr, env)
	...
	private length(expr: any[], env: any[]): number {
		const [list]: any[] = <[any[]]>this.inter.evalArgs(['list'], expr, env)
	...
	private makeList(expr: any[], env: any[]): any[] {
		const [size, fill]: [number, any] = <[number, any]>this.inter.evalArgs(['number', 'scalar'], expr, env)
	...
	private listTail(expr: any[], env: any[]): any[] {
		const [lst, k]: [any[], number] = <[any[], number]>this.inter.evalArgs(['list', 'number'], expr, env)
